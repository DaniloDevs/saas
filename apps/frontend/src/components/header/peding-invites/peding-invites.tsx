...
import { getPendingInvites } from '@/https/invites/get-peding-invites'
...
export function PendingInvites() {
   ...
   return (
      <Popover open={isOpen} onOpenChange={setIsOpen}>
         ...
         <PopoverContent className="w-80 space-y-2" side='bottom' >
            <span className="block text-sm font-medium">More actions
